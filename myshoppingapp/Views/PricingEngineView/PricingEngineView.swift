...
struct PricingEngineView: View {
    @StateObject var pricingEngineViewModel = PricingEngineViewModel()
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    HStack {
                        ...
                        Text(StringConstants.kLblTitle)
                    ...
                    .frame(width: getRelativeWidth(216.0), height: getRelativeHeight(24.0),
                           alignment: .leading)
                ...
                .frame(width: getRelativeWidth(397.0), height: getRelativeHeight(740.0),
                       alignment: .center)
...
struct PricingEngineView_Previews: PreviewProvider {
